...
#SBATCH --output="/home/mmedvedev/schnm/log/ALL_CONSTANTS_CUSTOM_RELU_16_MAY_symmetric/{functional}_0.4_{omega:.5f}_"%j.out
#SBATCH --constraint="type_e"
#SBATCH --time=3-0
# Executable
python test.py --Name {functional} --N_preopt 3 --N_train 1000 --Batch_size {batch_size} --Dropout 0.4 --Omega {omega:.5f} --LR_predopt 0.02'''
