...
#SBATCH --output="/home/mmedvedev/schnm/log/13_august/RELATIVE_AE17/{functional}_0.6_{omega:.5f}_"%j.out
#SBATCH --constraint="type_e"
#SBATCH --time=3-0
# Executable
python predopt_train.py --Name {functional} --N_preopt 3 --N_train 300 --Batch_size {batch_size} --Dropout 0.6 --Omega {omega:.5f} --LR_predopt 0.02'''
