...
def write_reports(experiment: Experiment) -> None:
    ...
    payload = {
        ...
        "wtmad_dispersion_correction": experiment.manifest.wtmad_dispersion_correction,
    ...
    lines = [
        ...
        f"- WTMAD dispersion correction: `{experiment.manifest.wtmad_dispersion_correction}`",
